...
struct  _UeInfoM
{
  ...
  int32_t rnti;
  /*
   * specific UE measurements reported by the gNB
   */
  protobuf_c_boolean has_ber;
  float ber;
  /*
   * specific UE control properties sent by the xApp
   */
  protobuf_c_boolean has_apply_control;
  protobuf_c_boolean apply_control;
  protobuf_c_boolean has_mcs_offset;
  float mcs_offset;
};
