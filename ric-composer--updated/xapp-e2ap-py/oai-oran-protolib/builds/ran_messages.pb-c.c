...
static const ProtobufCFieldDescriptor ue_info_m__field_descriptors[4] =
{
  ...
  },
  {
    ...
    offsetof(UeInfoM, has_ber),
    offsetof(UeInfoM, ber),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    offsetof(UeInfoM, has_apply_control),
    offsetof(UeInfoM, apply_control),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_FLOAT,
    offsetof(UeInfoM, has_mcs_offset),
    offsetof(UeInfoM, mcs_offset),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const unsigned ue_info_m__field_indices_by_name[] = {
  2,   /* field[2] = apply_control */
  1,   /* field[1] = ber */
  3,   /* field[3] = mcs_offset */
  0,   /* field[0] = rnti */
};
